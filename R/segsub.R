...
##'     \itemize{
##'        \item BLA5/BLD5: Bole aerial/Bole dead
##'        \item BSOIL: Bare soil
##'        \item RCK: Rock
##'        \item WATER: Water
##'        \item WDG5/WDG1: Wood on the ground (at least 5cm/1cm diameter)
##'        \item MSSG: Moss
##'        \item TIPA: Tip-up
##'        \item STPA: ?
##'        \item LITT/LITM/LITC/LITD: General/Mixed/Coniferous/Deciduous litters
...
##'        \item MSBLA5: Moss on aerial bole (at least 5cm diameter)
##'        \item MSWDG5: Moss on dead aerial wood (at least 5cm diameter)
##'     }
...
##'     \item SUMG: Derived variable (sum on ground?)
##'     \item SUMA: Derived variable (sum of aerial?)
##'     \item CORRECT: Derived variable (?)
##' }
"segsub"
